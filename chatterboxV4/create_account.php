...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_FILES['profile']) && $_FILES['profile']['error'] == 0) {
        ...
        if(!in_array($fileType, $validFiles)) {
            ...
            $profilePicPath =$profilePicPath = "ProfilePics/default.jpeg" ;
        }
...
<div class="breadcrumbs">
        <ul>
            <li><a href="index.php" style="color: #8a9c8a;">Home</a> |</li>
            <li>
                <p style="color: #374a37">Create Account</p>
            </li>
        </ul>
    </div>
    ...
    <script>
        ...
        var passcheck= document.getElementById("confirm-password");

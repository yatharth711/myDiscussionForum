...
<?php
    if (isset($_GET['uid'])) {
        ...
        $sql = "SELECT username, date, profile FROM users WHERE uid = $uid";
...
<div class = "flex-container">
    <div class = "flex">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<a href="viewPost.php?con_id='.$con_id.'">'.$title.'</a>';
            echo '<div class="postContainer">';
            echo '<div class="contentcore">' . $row['score'] . '</div>';
            echo '<a href="viewPost.php?con_id='.$con_id.'" class="commentButton"><i class="fa-regular fa-comment"></i></a>';
            echo '</div>';
            echo '</div>';
        }
        ?>
        ...
        <script>
    function redirectToPost(con_id){
        window.location.href = "viewPost.php?con_id="+con_id;
    }
    </script>
    <!-- END DISPLAY content -->
...
<div class = "flex-right"> 
    ...
    <?php
      ...
      $sql = "SELECT comments.content, content.title, content.con_id, communities.name 
              FROM comments 
              JOIN content ON comments.con_id = content.con_id 
      ...
      while ($row = mysqli_fetch_assoc($result)) {
          ...
          $con_id = $row['con_id'];
          $name = $row['name']; 
        echo '<a href="viewPost.php?con_id='.$con_id.'">'.$post_title.'</a>';
        echo '<p>'.$content.'</p>';
        echo '<hr>';
      }
    ?>
